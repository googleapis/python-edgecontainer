...
from google.cloud.edgecontainer_v1.services.edge_container import EdgeContainerAsyncClient
from google.cloud.edgecontainer_v1.services.edge_container import EdgeContainerClient
from google.cloud.edgecontainer_v1.services.edge_container import pagers
from google.cloud.edgecontainer_v1.services.edge_container import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert EdgeContainerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert EdgeContainerClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert EdgeContainerClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert EdgeContainerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert EdgeContainerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


@pytest.mark.parametrize("client_class,transport_name", [
    (EdgeContainerClient, "grpc"),
    (EdgeContainerAsyncClient, "grpc_asyncio"),
    (EdgeContainerClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.EdgeContainerRestTransport, "rest"),
])
def test_edge_container_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, "grpc_asyncio"),
    (EdgeContainerClient, transports.EdgeContainerRestTransport, "rest"),
])
@mock.patch.object(EdgeContainerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerClient))
@mock.patch.object(EdgeContainerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerAsyncClient))
def test_edge_container_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (EdgeContainerClient, transports.EdgeContainerGrpcTransport, "grpc", "false"),
    (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (EdgeContainerClient, transports.EdgeContainerRestTransport, "rest", "true"),
    (EdgeContainerClient, transports.EdgeContainerRestTransport, "rest", "false"),
])
@mock.patch.object(EdgeContainerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerClient))
@mock.patch.object(EdgeContainerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_edge_container_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    EdgeContainerClient, EdgeContainerAsyncClient
])
@mock.patch.object(EdgeContainerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerClient))
@mock.patch.object(EdgeContainerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EdgeContainerAsyncClient))
...
def test_edge_container_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (EdgeContainerClient, transports.EdgeContainerGrpcTransport, "grpc", grpc_helpers),
    (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (EdgeContainerClient, transports.EdgeContainerRestTransport, "rest", None),
])
def test_edge_container_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_edge_container_client_client_options_from_dict():
    with mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerGrpcTransport.__init__') as grpc_transport:
...
def test_edge_container_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_list_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resources.Cluster)
                   for i in results)
...
@pytest.mark.asyncio
async def test_generate_access_token_async(transport: str = 'grpc_asyncio', request_type=service.GenerateAccessTokenRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.GenerateAccessTokenResponse(
            access_token='access_token_value',
        ))
...
@pytest.mark.asyncio
async def test_list_node_pools_async(transport: str = 'grpc_asyncio', request_type=service.ListNodePoolsRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListNodePoolsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_node_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.NodePool)
                   for i in results)
...
async def test_list_node_pools_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_node_pools(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_list_node_pools_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_node_pools(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_node_pool_async(transport: str = 'grpc_asyncio', request_type=service.GetNodePoolRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_node_pool_async(transport: str = 'grpc_asyncio', request_type=service.CreateNodePoolRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_node_pool_async(transport: str = 'grpc_asyncio', request_type=service.UpdateNodePoolRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_node_pool_async(transport: str = 'grpc_asyncio', request_type=service.DeleteNodePoolRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_machines(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_machines),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_machines_async(transport: str = 'grpc_asyncio', request_type=service.ListMachinesRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListMachinesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_machines_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.Machine)
                   for i in results)
...
async def test_list_machines_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_machines(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_list_machines_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_machines(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_machine(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_machine),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_machine_async(transport: str = 'grpc_asyncio', request_type=service.GetMachineRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_vpn_connections_async(transport: str = 'grpc_asyncio', request_type=service.ListVpnConnectionsRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(service.ListVpnConnectionsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_vpn_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.VpnConnection)
                   for i in results)
...
async def test_list_vpn_connections_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_vpn_connections(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_list_vpn_connections_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_vpn_connections(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_vpn_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vpn_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_vpn_connection_async(transport: str = 'grpc_asyncio', request_type=service.GetVpnConnectionRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.VpnConnection(
            name='name_value',
            nat_gateway_ip='nat_gateway_ip_value',
            bgp_routing_mode=resources.VpnConnection.BgpRoutingMode.REGIONAL,
            cluster='cluster_value',
...
def test_create_vpn_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_vpn_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_vpn_connection_async(transport: str = 'grpc_asyncio', request_type=service.CreateVpnConnectionRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_vpn_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_vpn_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_vpn_connection_async(transport: str = 'grpc_asyncio', request_type=service.DeleteVpnConnectionRequest):
    client = EdgeContainerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_clusters_rest_unset_required_fields():
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_clusters_rest_interceptors(null_interceptor):
    transport = transports.EdgeContainerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor(),
        )
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_clusters") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_list_clusters") as pre:
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_cluster") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_get_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_cluster") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_create_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_update_cluster") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_update_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_cluster") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_delete_cluster") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_access_token_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = service.GenerateAccessTokenResponse(
              access_token='access_token_value',
        )
...
def test_generate_access_token_rest_required_fields(request_type=service.GenerateAccessTokenRequest):
    transport_class = transports.EdgeContainerRestTransport
...
def test_generate_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_access_token") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_generate_access_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.GenerateAccessTokenRequest.pb(service.GenerateAccessTokenRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.GenerateAccessTokenResponse.to_json(service.GenerateAccessTokenResponse())
...
def test_generate_access_token_rest_bad_request(transport: str = 'rest', request_type=service.GenerateAccessTokenRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_access_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'cluster': 'projects/sample1/locations/sample2/clusters/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{cluster=projects/*/locations/*/clusters/*}:generateAccessToken" % client.transport._host, args[1])
...
def test_list_node_pools_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = service.ListNodePoolsResponse(
              next_page_token='next_page_token_value',
              unreachable=['unreachable_value'],
        )
...
def test_list_node_pools_rest_required_fields(request_type=service.ListNodePoolsRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_node_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_node_pools") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_list_node_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListNodePoolsResponse.to_json(service.ListNodePoolsResponse())
...
def test_list_node_pools_rest_bad_request(transport: str = 'rest', request_type=service.ListNodePoolsRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_node_pools_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListNodePoolsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pager = client.list_node_pools(request=sample_request)
        ...
        pages = list(client.list_node_pools(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_node_pool_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = resources.NodePool(
              name='name_value',
              node_location='node_location_value',
              node_count=1070,
              machine_filter='machine_filter_value',
...
def test_get_node_pool_rest_required_fields(request_type=service.GetNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_node_pool") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_get_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.NodePool.to_json(resources.NodePool())
...
def test_get_node_pool_rest_bad_request(transport: str = 'rest', request_type=service.GetNodePoolRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_node_pool_rest_required_fields(request_type=service.CreateNodePoolRequest):
    transport_class = transports.EdgeContainerRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["node_pool_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    # verify required fields with default values are now present
    assert "nodePoolId" in jsonified_request
    assert jsonified_request["nodePoolId"] == request_init["node_pool_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_node_pool._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("node_pool_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_node_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("nodePoolId", "requestId", )) & set(("parent", "nodePoolId", "nodePool", )))
...
def test_create_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_node_pool") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_create_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_node_pool_rest_bad_request(transport: str = 'rest', request_type=service.CreateNodePoolRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_update_node_pool") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_update_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_node_pool_rest_bad_request(transport: str = 'rest', request_type=service.UpdateNodePoolRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_node_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'node_pool': {'name': 'projects/sample1/locations/sample2/clusters/sample3/nodePools/sample4'}}
        ...
        client.update_node_pool(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{node_pool.name=projects/*/locations/*/clusters/*/nodePools/*}" % client.transport._host, args[1])
...
def test_delete_node_pool_rest_required_fields(request_type=service.DeleteNodePoolRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_node_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_node_pool") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_delete_node_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_node_pool_rest_bad_request(transport: str = 'rest', request_type=service.DeleteNodePoolRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_machines_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = service.ListMachinesResponse(
              next_page_token='next_page_token_value',
              unreachable=['unreachable_value'],
        )
...
def test_list_machines_rest_required_fields(request_type=service.ListMachinesRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_machines._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_machines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_machines") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_list_machines") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListMachinesResponse.to_json(service.ListMachinesResponse())
        ...
        client.list_machines(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_machines_rest_bad_request(transport: str = 'rest', request_type=service.ListMachinesRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_machines_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_machines(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/machines" % client.transport._host, args[1])
...
def test_list_machines_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListMachinesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pager = client.list_machines(request=sample_request)
        ...
        pages = list(client.list_machines(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_machine_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/machines/sample3'}
    request = request_type(**request_init)

    # Mock the http request call within the method and fake a response.
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = resources.Machine(
              name='name_value',
              hosted_node='hosted_node_value',
              zone='zone_value',
              disabled=True,
...
def test_get_machine_rest_required_fields(request_type=service.GetMachineRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_machine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_machine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_machine") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_get_machine") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.Machine.to_json(resources.Machine())
        ...
        client.get_machine(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_machine_rest_bad_request(transport: str = 'rest', request_type=service.GetMachineRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_machine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/machines/sample3'}
        ...
        client.get_machine(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/machines/*}" % client.transport._host, args[1])
...
def test_list_vpn_connections_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = service.ListVpnConnectionsResponse(
              next_page_token='next_page_token_value',
              unreachable=['unreachable_value'],
        )
...
def test_list_vpn_connections_rest_required_fields(request_type=service.ListVpnConnectionsRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vpn_connections._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vpn_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_vpn_connections") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_list_vpn_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.ListVpnConnectionsRequest.pb(service.ListVpnConnectionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListVpnConnectionsResponse.to_json(service.ListVpnConnectionsResponse())
        ...
        client.list_vpn_connections(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_vpn_connections_rest_bad_request(transport: str = 'rest', request_type=service.ListVpnConnectionsRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_vpn_connections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_vpn_connections(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/vpnConnections" % client.transport._host, args[1])
...
def test_list_vpn_connections_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(service.ListVpnConnectionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_vpn_connections(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_vpn_connection_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/vpnConnections/sample3'}
    request = request_type(**request_init)

    # Mock the http request call within the method and fake a response.
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = resources.VpnConnection(
              name='name_value',
              nat_gateway_ip='nat_gateway_ip_value',
              bgp_routing_mode=resources.VpnConnection.BgpRoutingMode.REGIONAL,
              cluster='cluster_value',
...
def test_get_vpn_connection_rest_required_fields(request_type=service.GetVpnConnectionRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_vpn_connection") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_get_vpn_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.GetVpnConnectionRequest.pb(service.GetVpnConnectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.VpnConnection.to_json(resources.VpnConnection())
        ...
        client.get_vpn_connection(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_vpn_connection_rest_bad_request(transport: str = 'rest', request_type=service.GetVpnConnectionRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_vpn_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/vpnConnections/sample3'}
        ...
        client.get_vpn_connection(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/vpnConnections/*}" % client.transport._host, args[1])
...
def test_create_vpn_connection_rest_required_fields(request_type=service.CreateVpnConnectionRequest):
    transport_class = transports.EdgeContainerRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["vpn_connection_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(
        pb_request,
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "vpnConnectionId" in jsonified_request
    assert jsonified_request["vpnConnectionId"] == request_init["vpn_connection_id"]
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_vpn_connection._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "vpn_connection_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_vpn_connection_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "vpnConnectionId", )) & set(("parent", "vpnConnectionId", "vpnConnection", )))
...
def test_create_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_create_vpn_connection") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_create_vpn_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.CreateVpnConnectionRequest.pb(service.CreateVpnConnectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_vpn_connection(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_vpn_connection_rest_bad_request(transport: str = 'rest', request_type=service.CreateVpnConnectionRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_vpn_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.create_vpn_connection(**mock_args)
...
def test_delete_vpn_connection_rest_required_fields(request_type=service.DeleteVpnConnectionRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_vpn_connection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "post_delete_vpn_connection") as post, \
         mock.patch.object(transports.EdgeContainerRestInterceptor, "pre_delete_vpn_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = service.DeleteVpnConnectionRequest.pb(service.DeleteVpnConnectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_vpn_connection(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_vpn_connection_rest_bad_request(transport: str = 'rest', request_type=service.DeleteVpnConnectionRequest):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_vpn_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.delete_vpn_connection(**mock_args)
...
def test_edge_container_base_transport():
    ...
    with mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerTransport.__init__') as Transport:
...
def test_edge_container_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_edge_container_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EdgeContainerTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.EdgeContainerGrpcTransport, transports.EdgeContainerGrpcAsyncIOTransport])
def test_edge_container_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_edge_container_host_no_port(transport_name):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='edgecontainer.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'edgecontainer.googleapis.com:443'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://edgecontainer.googleapis.com'
    )
...
def test_edge_container_host_with_port(transport_name):
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='edgecontainer.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
        'edgecontainer.googleapis.com:8000'
        if transport_name in ['grpc', 'grpc_asyncio']
        else 'https://edgecontainer.googleapis.com:8000'
    )
...
def test_edge_container_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.list_machines._session
    session2 = client2.transport.list_machines._session
    assert session1 != session2
    session1 = client1.transport.get_machine._session
    session2 = client2.transport.get_machine._session
    assert session1 != session2
    session1 = client1.transport.list_vpn_connections._session
    session2 = client2.transport.list_vpn_connections._session
    assert session1 != session2
    session1 = client1.transport.get_vpn_connection._session
    session2 = client2.transport.get_vpn_connection._session
    assert session1 != session2
    session1 = client1.transport.create_vpn_connection._session
    session2 = client2.transport.create_vpn_connection._session
    assert session1 != session2
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.EdgeContainerGrpcTransport, transports.EdgeContainerGrpcAsyncIOTransport])
def test_edge_container_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_crypto_key_path():
    ...
    actual = EdgeContainerClient.crypto_key_path(project, location, key_ring, crypto_key)
    assert expected == actual
...
def test_crypto_key_version_path():
    ...
    actual = EdgeContainerClient.crypto_key_version_path(project, location, key_ring, crypto_key, crypto_key_version)
    assert expected == actual
...
def test_machine_path():
    ...
    location = "clam"
    machine = "whelk"
    expected = "projects/{project}/locations/{location}/machines/{machine}".format(project=project, location=location, machine=machine, )
...
def test_node_pool_path():
    ...
    cluster = "winkle"
    node_pool = "nautilus"
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/nodePools/{node_pool}".format(project=project, location=location, cluster=cluster, node_pool=node_pool, )
...
def test_vpn_connection_path():
    ...
    expected = "projects/{project}/locations/{location}/vpnConnections/{vpn_connection}".format(project=project, location=location, vpn_connection=vpn_connection, )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.EdgeContainerTransport, '_prep_wrapped_messages') as prep:
        client = EdgeContainerClient(
            credentials=ga_credentials.AnonymousCredentials(),
