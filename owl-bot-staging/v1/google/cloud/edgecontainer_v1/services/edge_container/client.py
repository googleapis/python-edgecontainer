...
class EdgeContainerClient(metaclass=EdgeContainerClientMeta):
    ...
    @staticmethod
    def machine_path(project: str,location: str,machine: str,) -> str:
        """Returns a fully-qualified machine string."""
        return "projects/{project}/locations/{location}/machines/{machine}".format(project=project, location=location, machine=machine, )
    ...
    @staticmethod
    def node_pool_path(project: str,location: str,cluster: str,node_pool: str,) -> str:
        """Returns a fully-qualified node_pool string."""
        return "projects/{project}/locations/{location}/clusters/{cluster}/nodePools/{node_pool}".format(project=project, location=location, cluster=cluster, node_pool=node_pool, )
    ...
    @staticmethod
    def vpn_connection_path(project: str,location: str,vpn_connection: str,) -> str:
        """Returns a fully-qualified vpn_connection string."""
        return "projects/{project}/locations/{location}/vpnConnections/{vpn_connection}".format(project=project, location=location, vpn_connection=vpn_connection, )
